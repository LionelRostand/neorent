      ...
      <Card className="h-fit w-full">
        ...
        <CardContent className="space-y-1 p-4 pt-0">
          {quickActions.map((action) => {
            ...
            const PreviewIcon = action.previewIcon;
            return (
              <div key={action.title} className="border border-gray-200 rounded-lg p-3 hover:shadow-sm transition-shadow">
                <Button
                  variant="ghost"
                ...
                <div className="mt-3 bg-gray-50 rounded-lg p-3">
                  <div className="flex items-center justify-center text-center">
                    <div>
                      ...
                      <p className="text-xs text-gray-600 font-medium">{action.preview}</p>
                    </div>
                  </div>
                </div>
              </div>
