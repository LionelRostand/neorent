...
import { Plus, Calculator, TrendingUp, AlertCircle, DollarSign, Edit, Trash2, Eye } from 'lucide-react';
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-gradient-to-r from-yellow-600 to-yellow-700 rounded-xl p-6 text-white shadow-lg">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold">Charges Locatives</h1>
            <p className="text-yellow-100 mt-2">Gérez vos charges et provisions</p>
          </div>
          <Button 
            className="bg-white text-yellow-600 hover:bg-yellow-50 border-0 shadow-md"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="border-l-4 border-l-red-500 hover:shadow-lg transition-shadow">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-gray-900">{annualCharges}</div>
      ...
      <Card className="shadow-lg border-0">
        <CardHeader className="bg-gradient-to-r from-gray-50 to-white border-b">
          <CardTitle className="text-xl text-gray-800">Liste des Charges</CardTitle>
        </CardHeader>
        <CardContent className="p-6">
          {charges.length === 0 ? (
            <div className="text-center py-12 bg-gradient-to-br from-gray-50 to-white rounded-lg border-2 border-dashed border-gray-200">
              ...
              <h3 className="text-lg font-medium text-gray-700 mb-2">Aucune charge trouvée</h3>
              <p className="text-gray-500 mb-4">Commencez par ajouter vos premières charges</p>
              ...
              <TableBody>
                {charges.map((charge) => (
                  <TableRow key={charge.id}>
                    ...
                    <TableCell>{charge.electricity}€</TableCell>
                    <TableCell>{charge.water}€</TableCell>
                    <TableCell>{charge.heating}€</TableCell>
